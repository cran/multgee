...
\Plaintitle{R Package multgee: A Generalized Estimating Equations Solver for Multinomial Responses} 
...
\Plainkeywords{generalized estimating equations, nominal and ordinal multinomial responses, local odds ratios, R} 
\Address{
  Anestis Touloumis\\
